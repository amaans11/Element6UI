			...
			},
			{
				...
				cell: (row) => (
					<div style={{ marginLeft: 40 }}>
						{row['date_created'] && moment(row['date_created']).format('DD-MM-YYYY hh:mm:ss A')}
					</div>
				)
			},
			{
			...
			<Grid container>
				...
				<Grid item xs={8} className={classes.contentView}>
					<Typography align="center" variant="h4">
						Welcome to the Urgentem Element 6<sup style={{ verticalAlign: 'super', fontSize: 12 }}>
							TM
						</sup>{' '}
						Platform.
					</Typography>
					...
					<Box mt={1}>
						...
						<Typography style={{ color: 'rgb(120,120,120),fontSize:12' }}>
							To delete any of the portfolios uploaded to your account, please click on the link below and
					...
					<Box mt={2}>
						<DataTable data={portfolioTableRes} columns={headCells} tableHeading="UPLOAD_PORTFOLIO" />
					</Box>
				</Grid>
			</Grid>
