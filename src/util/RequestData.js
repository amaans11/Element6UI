  ...
  switch (type) {
    ...
    case 'TARGET_SETTING':
      data = {
        ...
        sector: sector,
        footprint: footprintMetric == 'CarbIntensityMarketVal' || footprintMetric == 'CarbIntensityRev' ? 'WeightAvgRev' : filterItem.approach == 'RelativeAlignment'? footprintMetric : 'TotalCarbEmis',
        market_value: marketValue,
        inference: 'Avg',
        asset_type: 'EqCB',
        approach: approach,
